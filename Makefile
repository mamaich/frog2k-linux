...
USERSPACE_WDT_SRC := userspace/sf2000-wdt.c
USERSPACE_WDT := $(USERSPACE_GENERATED_OVERLAY)/usr/sbin/sf2000-wdt
...
$(USERSPACE_WDT): $(USERSPACE_WDT_SRC) $(PIE_STAMP) $(TOOLCHAIN_STAMP) Makefile
	mkdir -p '$(dir $@)'
	$(TARGET_CC_RUN) $(USERSPACE_PIE_CFLAGS) $(USERSPACE_PIE_LDFLAGS) \
		-o '$@' '$(PIE_SYSROOT)'/rcrt1.o '$(PIE_SYSROOT)'/crti.o \
		$$('$(TARGET_CC)' -print-file-name=crtbeginS.o) \
